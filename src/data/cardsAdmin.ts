export const cardsAdminGeneral = [
  {
    id: 1,
  ...
  },
  {
    ...
    icon: `<svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
      ...
      iconFontawesome:"fas fa-user-tag",
  },
  {
    id: 3,
  ...
  iconFontawesome:"fas fa-tags",
  },
];
export const cardsAdminShop = [
  {
    id: 1,
    name: "Gestión de Productos",
    icon: `<svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
  ...
  iconFontawesome:" fas fa-ticket-alt",
  },
  {
    id: 4,
  ...
  iconFontawesome:"fas fa-shopping-cart",
  },
  {
    id: 5,
    name: "Gestión de Localización",
    icon: `<svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
  </svg>`,
  iconFontawesome:"fas fa-map-marker-alt",
  },
];
